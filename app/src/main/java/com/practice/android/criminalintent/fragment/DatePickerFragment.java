...
public class DatePickerFragment extends DialogFragment {
    ...
    public static final String EXTRA_CRIME_DATE = "com.android.practice.extra_crime_date";
    private static final String ARG_CRIME_DATE = "com.android.practice.arg_crime_date";
    ...
    private void sendResult(int resultCode, Date date) {
        // Check if there is target fragment
